...
def stop_ec2_instances():
    ...
    # Caso queira que o script rode em todas as regiões da AWS
    regions = ec2_client.describe_regions()
    # Caso queira que o scritp rode em apenas uma região em específico
    #regions = regions={'Regions': [{'RegionName': 'sa-east-1'}]}
